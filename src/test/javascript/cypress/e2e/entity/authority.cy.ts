...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '50499b60-ec41-4b66-841e-3605f54ee357' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2d8e9c3e-43a5-47f1-96cc-5aaa09b4918c');
      cy.get(`[data-cy="name"]`).should('have.value', '2d8e9c3e-43a5-47f1-96cc-5aaa09b4918c');
